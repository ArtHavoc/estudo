...
public class AventuraRepository {
	...
	public Caminho carregarAventura() {
		...
		Caminho caminhoAlt1Arpao = new Caminho(1, "Arpao", "Atacou com arpao e deu certo");
		Caminho caminhoAlt1PatoBorracha = new Caminho(2, "Pato de borracha", "Atacou com pato de borracha e deu mto ruim", false);
		...
		Caminho caminhoAlt2Pedra = new Caminho(2, "Pedra", "Atacou com pedra e deu mto ruim", false);
